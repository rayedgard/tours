...
insert  into `categoriafotos`(`idCategoriaFoto`,`nombreCategoria`,`eliminar`) values (1,'CAMINO INCA',0),(2,'CHOQUEQUIRAO',0),(3,'CUSCO',0),(4,'LARES',0),(5,'MACHUPICCHU',0),(6,'PAUCARTAMBO',0),(7,'SALKANTAY',0),(8,'VALLE SAGRADO',0),(9,'VALLE SUR',0);
...
insert  into `eventos`(`id`,`nombre`,`linkeventos`,`imagen`,`descripcion`,`fecha`,`eliminar`,`idioma`) values (1,'evento nÂ° 01 ','http://peru21.pe/actualidad/machu-picchu-restriccion-acceso-buses-ciudadela-no-afecta-visitas-2165977','ausangate.jpg','<p>Descripci&oacute;n del Evento... jsdjdaksjdsad a daskdjsakda d asdasdsa</p>','2015-08-20',0,0);
