...
?>				
				...
				<div class="grid_3 prefix_1">
					<h5 class="wow bounceInRight" data-wow-delay="0.4s"><?php echo $titulo2;?></h5>
					<ul class="list">
                    	   ...
                    	   <?php
			  				...
			  				{
			   				?>
								<li class="wow bounceInRight animated" data-wow-delay="0.6s"><a href="paquete.php?cod=<?php echo $idPaqueteAl[$k];?>&i=<?php echo $i;?>"><?php echo $nombrePaqueteAl[$k]; ?></a></li>
                ...
                <!--====================para los destinos===================================---->       
          <div class="grid_3 prefix_1">
					<h5 class"wow fadeInUpBig animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;"><?php echo $titulo3;?></h5>
		...
		array_push($nombreDestino,$row2[2]);
			  ...
			  for($k=0;$k<count($idDestino);$k++)
			  {
			   ?>
						...
						<a href="destino.php?cod=<?php echo $id; ?>&cod1=<?php echo $idDestino[$k]; ?>&i=<?php echo $i;?>"> <img class="destinos wow bounceInLeft animated" data-wow-delay="0.5s" src="../../administracion/imagenes/destinos/<?php echo $imagenDestino[$k];?>" alt=""></a>
