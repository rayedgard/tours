...
///////////ruta donde estan los archivos
//cambiamos el codigo para poner una ruta estatica del archivo de imagen
$ruta_completa_ar = str_replace('filebrowser.php', '', $_SERVER['PHP_SELF']).'archivos/';//ruta original
//$ruta_completa_ar = 'tiny_mce/plugins/jfilebrowser/archivos/';//ruta cambiada
